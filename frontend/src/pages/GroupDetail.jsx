      ...
      <div className="group-detail-container" style={{ maxWidth: '1100px', margin: '0 auto', padding: '40px 48px 48px' }}>
        ...
        <div className="group-header-card" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', marginBottom: '28px', overflow: 'hidden', boxShadow: 'var(--shadow)' }}>
          ...
          <div className="group-header-content" style={{ padding: '28px 32px' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', marginBottom: '16px', flexWrap: 'wrap' }}>
              ...
              <span style={{ fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', padding: '4px 12px', borderRadius: '6px', background: 'rgba(0,0,0,0.04)', color: 'var(--text-primary)', border: '1px solid var(--border)' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: '24px', flexWrap: 'wrap' }}>
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '8px 16px', background: 'rgba(0,0,0,0.04)', border: '1px solid var(--border)', borderRadius: '999px', alignSelf: 'flex-start' }}>
                <span style={{ fontSize: '16px', fontWeight: 700, color: 'var(--text-primary)' }}>{h.group.members.length}/{h.group.maxMembers || 10}</span>
        ...
        <div id="group-detail-tabs" className="profile-tabs" style={{ marginBottom: '32px' }}>
          {[
            {
              key: 'documents',
              label: isMobile ? 'Tài liệu' : 'Tài liệu học tập',
              icon: (
            ...
            {
              key: 'schedule',
              label: isMobile ? 'Lịch học' : 'Lịch học nhóm',
              icon: (
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round">
            ...
            {
              key: 'deadlines',
              label: isMobile ? 'Deadline' : 'Deadline & Công việc',
              icon: (
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round">
            ...
            {
              key: 'chat',
              label: isMobile ? 'Chat' : 'Trò chuyện nhóm',
              icon: (
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
                </svg>
              ),
              badge: h.unreadChatCount
            },
            {
              key: 'members',
              label: isMobile ? 'TViên' : 'Thành viên',
              icon: (
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round">
            ...
            <button
              ...
              style={{ whiteSpace: 'nowrap', position: 'relative', display: 'inline-flex', alignItems: 'center', gap: '6px' }}
            >
              {icon}
              <span>{label}</span>
              {badge > 0 && (
