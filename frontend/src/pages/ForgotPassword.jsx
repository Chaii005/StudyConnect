...
export default function ForgotPassword() {
  ...
  const handleVerifyAndReset = async (e) => {
    ...
    if (!otp || otp.trim().length !== 8) {
      setError('Vui lòng nhập mã xác nhận (OTP) gồm 8 số.');
      return;
    }
          ...
          <div style={{ animation: 'fadeIn 0.3s ease' }}>
            ...
            <form onSubmit={handleVerifyAndReset} noValidate>
              ...
              <div className="form-group" style={{ marginBottom: '16px' }}>
                <label className="form-label" htmlFor="otp-code" style={{ fontSize: '13px', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '6px', display: 'block' }}>Mã OTP (8 chữ số)</label>
                <div className="form-input-wrap" style={{ position: 'relative' }}>
